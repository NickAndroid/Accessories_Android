...
import dev.nick.accessories.injection.annotation.binding.BindLongArray;
import dev.nick.accessories.resource.ResourceAccessories;

class LongArrProcessor extends FieldProcessor {

    public LongArrProcessor(Context appContext) {
        super(appContext);
    }
    ...
    protected Object parseField(Field field) {
        ...
        return ResourceAccessories.getLongIntArray(getContext().getResources(), checkId(id));
    }
