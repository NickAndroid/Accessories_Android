...
class ViewProcessor extends FieldProcessor {
    ...
    protected Object parseField(Object container, Field field) {
        ...
        if (isProvider) {
            ...
            rootView = (View) container;
        } else if (container instanceof RecyclerView.ViewHolder) {
            RecyclerView.ViewHolder holder = (RecyclerView.ViewHolder) container;
        ...
        Preconditions.checkNotNull(rootView, "No root view detected.");
