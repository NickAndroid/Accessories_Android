...
public class ApplicationTest extends ApplicationTestCase<Application> {
    ...
    public void testShared() {
        ImageLoader loader1 = ImageLoader.shared(getContext());
        ImageLoader loader2 = ImageLoader.shared(getContext(), LoaderConfig.DEFAULT_CONFIG);
    ...
    public void testCreate() {
        ...
        ImageLoader loader3 = ImageLoader.shared(getContext());
