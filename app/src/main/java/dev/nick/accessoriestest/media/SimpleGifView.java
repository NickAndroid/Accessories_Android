...
public class SimpleGifView extends View {
    ...
    public SimpleGifView(Context context) {
        this(context, null);
    }

    public SimpleGifView(Context context, AttributeSet attrs) {
        this(context, attrs, R.styleable.CustomTheme_gifViewStyle);
    }

    public SimpleGifView(Context context, AttributeSet attrs, int defStyle) {
